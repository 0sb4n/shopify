      ...
      <CardContent>
        <ScrollArea className="h-[400px] pr-4 ">
          {messages.map((message) => (
            <div
              key={message.id}
              className={`flex items-start shadow-lg mb-4 ${
                message.sender === 'client' ? 'justify-end' : 'justify-start'
              }`}
            >
              {message.sender === 'admin' && (
                <Avatar className="mr-2">
                  <AvatarImage src="/assets/icons/admin.svg?height=40&width=40" alt="Admin" />
              ...
              {message.sender === 'client' && (
                <Avatar className="ml-2 shadow-xl">
                  <AvatarImage src="/assets/icons/voite.svg?height=40&width=40" alt="Client" />
      ...
      <CardFooter>
        ...
        >
          <Input
            ...
            className="flex-grow shadow-lg border-none"
          />
